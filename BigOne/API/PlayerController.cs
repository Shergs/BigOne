...
public class PlayerController : ControllerBase
{
    ...
    [HttpPost("playsound")]
    public async Task<IActionResult> PlaySound([FromQuery] string serverId, [FromQuery] string username, [FromQuery] string soundName, [FromQuery] string voiceChannelId)
    {
